...
namespace Biblioteca.Infrastructure.Migrations
{
    ...
    [Migration("20230928180018_ExemplarReserva")]
    partial class ExemplarReserva
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ReservaExemplar", b =>
                {
                    ...
                    b.Property<ulong>("ExemplarId")
                        .HasColumnType("bigint unsigned")
                        .HasColumnName("exemplarId");

                    b.HasKey("ReservaId", "ExemplarId")
                        .HasName("PRIMARY");

                    b.HasIndex(new[] { "ExemplarId" }, "fk_reserva_has_exemplares_exemplares1");

                    b.ToTable("reservaExemplar", (string)null);
                });
            ...
            modelBuilder.Entity("ReservaExemplar", b =>
                {
                    b.HasOne("Biblioteca.Domain.Entities.Exemplare", null)
                        .WithMany()
